...
int m=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View vi = (View) findViewById(R.id.main1);
        vi.setX(2);
        vi.setY(2);
        ...
        but.setOnTouchListener(new View.OnTouchListener() {
            ...
            Runnable mAction = new Runnable() {
                ...
                public void run() {
                    // Do continuous task.
                    RelativeLayout relativeLayout = (RelativeLayout) findViewById(R.id.shasha);
                    View vi = (View) findViewById(R.id.main1);
                    View vi1 = (View) findViewById(R.id.dup1);
                    float a = vi.getX();
                    float b = vi.getY();
                    ...
                    if(m==0) {
                        new CountDownTimer(45000, 1000) {
                            ...
                            public void onFinish() {
                                Intent intent=new Intent(Function.this,Try.class);
    ...
    protected void onDestroy() {
        super.onDestroy();
        Intent intent=new Intent(Function.this,Hard.class);
        Function.this.startActivity(intent);

    }
    @Override
    public void onBackPressed() {
        Intent intent=new Intent(Function.this,Resume.class);
        intent.putExtra("ke",21);
        Function.this.startActivity(intent);
    }
}
